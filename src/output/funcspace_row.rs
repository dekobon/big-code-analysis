...
pub(crate) fn metric_values(space: &FuncSpace) -> [f64; METRIC_COUNT] {
    ...
    [
        ...
        // halstead
        hal.u_operators() as f64,
        hal.operators() as f64,
        hal.u_operands() as f64,
        hal.operands() as f64,
        hal.length() as f64,
        ...
        // nargs
        nrg.fn_args_sum() as f64,
        nrg.closure_args_sum() as f64,
        nrg.fn_args_average(),
        nrg.closure_args_average(),
        nrg.nargs_total() as f64,
        nrg.nargs_average(),
        nrg.fn_args_min() as f64,
        nrg.fn_args_max() as f64,
