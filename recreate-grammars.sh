...
cargo run --manifest-path ./enums/Cargo.toml -- -lrust -o ./big-code-analysis-ast/src/languages

# Recreate C macros
cargo run --manifest-path ./enums/Cargo.toml -- -lc_macros -o ./big-code-analysis-ast/src/c_langs_macros
