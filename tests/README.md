...
| tokens        | –  |  1 | –  | – |  1 | – | –  | –  | –  | –  | –  |  5 |  1 | –  | – | – |
| wmc (OOP)     | –  | –  | 13 | – | 13 | – | –  | –  | –  | –  | 13 | –  | –  | –  | – | – |
| **Total**     | 40 | 40 |110 | 48|104 |39 | 43 | 40 | 41 | 47 |102 | 50 | 47 | 57 |43 |42 |
| **Metrics ≥1 (/13)** | 7 | 8 | 11 |  7| 12 | 7 |  7 |  7 |  7 |  7 | 11 |  8 |  8 |  7 | 7 | 7 |
...
- [#168](https://github.com/dekobon/big-code-analysis/issues/168) —
  Kotlin has no real impl for `abc`/`npa`/`npm`/`wmc`; all four are
  no-op stubs in `implement_metric_trait!`.
- [#169](https://github.com/dekobon/big-code-analysis/issues/169) —
  Same gap for TypeScript and TSX.
