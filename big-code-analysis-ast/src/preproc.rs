...
//! The C-family preprocessor pass: the include graph, macro collection,
//! and the [`PreprocResults`] document.
...
pub fn preprocess_with_parser(parser: &PreprocParser, path: &Path, results: &mut PreprocResults) {
