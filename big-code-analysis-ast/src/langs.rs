...
//! The [`LANG`] enum, extension and emacs-mode lookup, the per-language
//! `*Code` tags and `*Parser` aliases, and [`AnyParser`].
...
mod tests {
    ...
    fn grammar_version_matches_cargo_toml_pin() {
        ...
        // workspace root whose manifest carries `[workspace.dependencies]`.
