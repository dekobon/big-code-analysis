...
//! Language detection and the file readers.
...
/// use std::path::Path;
///
/// use big_code_analysis_ast::read_file;
///
...
/// use std::path::Path;
///
/// use big_code_analysis_ast::read_file_with_eol;
///
/// let path = Path::new("Cargo.toml");
...
/// use std::path::Path;
///
/// use big_code_analysis_ast::{SkipReason, read_file_with_eol_classified};
///
...
///
/// ```
/// use big_code_analysis_ast::normalize_eol;
///
...
/// use std::path::Path;
///
/// use big_code_analysis_ast::write_file;
///
...
/// use std::path::Path;
///
/// use big_code_analysis_ast::get_language_for_file;
///
...
///
/// ```
/// use big_code_analysis_ast::is_generated;
///
...
///
/// use big_code_analysis_ast::guess_language;
///
...
pub fn normalize_line_endings(data: &mut Vec<u8>) {
