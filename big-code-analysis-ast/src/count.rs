...
//! Node counting by kind or category, and the shared [`CountCollector`].
...
/// worker threads of a `big_code_analysis::ConcurrentRunner` walk.
///
...
/// `big_code_analysis::ConcurrentRunner`. Recover the final tally with
