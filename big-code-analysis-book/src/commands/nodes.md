...
The `big-code-analysis-cli` provides commands to analyze and extract information from the nodes in the **Abstract Syntax Tree (AST)** of a source file.
...
```console
big-code-analysis-cli -p /path/to/your/file/or/directory -I "*.ext" -f error
```
...
```console
big-code-analysis-cli -p /path/to/your/file/or/directory -I "*.ext" --count <NODE_TYPE>
```
...
```console
big-code-analysis-cli -p /path/to/your/file/or/directory -d
```
...
```console
big-code-analysis-cli -p /path/to/your/file/or/directory -d --ls 5 --le 10
```
