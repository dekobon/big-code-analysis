...
See [/src/metrics/loc.rs](https://github.com/dekobon/big-code-analysis/blob/master/src/metrics/loc.rs) for where to implement, as well as examples from other languages.
